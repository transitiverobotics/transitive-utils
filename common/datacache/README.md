...
*   [DataCache][1]
    ...
    *   [subscribe][9]
    *   [subscribePath][10]
    *   [subscribePathFlat][11]
    *   [subscribeTopic][12]
    *   [unsubscribe][13]
    *   [update][14]
    *   [updateFromArray][15]
    *   [updateFromModifier][16]
    *   [updateFromTopic][17]
*   [dropWildcardIds][18]
    *   [Parameters][19]
*   [forMatchIterator][20]
...
*   `obj` **[object][42]** The object to select from
*   `path` **[array][43]** An array specifying the path to select, potentially
